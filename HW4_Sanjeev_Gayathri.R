...
FedCorpus <- Corpus(DirSource("Corpus"))
(FedCorpus)

## Here, I am keeping a list of the filenames so I can associate them with the DTM
FedFilesPath <- "C:/Users/gagd2/Desktop/Syracuse/IST_707/Assignments/Assignment_4/Corpus"
...
findAssocs(Fed_TermDM, 'legislature', 0.60)
...
inspect(Fed_Doc_TM)
View(as.matrix(Fed_Doc_TM[1:80, 1:50]))
